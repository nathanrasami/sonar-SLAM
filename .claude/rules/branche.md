...
- SSM/NSSM défaut ON depuis 07-07 (parité Bruce original) ; ancien état de réf
  (ATE 0.13 m, SLAM≡DR car 0 contrainte) = `SSM=false NSSM=false ./run_slam.sh holoocean`.
