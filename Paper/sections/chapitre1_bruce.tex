...
ATE over the mission (orange curve in figures~\ref{fig:bruce-err} and
...
\subsection{Results — Bruce-SLAM alone (start-pinned protocol, §~\ref{sec:protocole})}
\label{sec:chap1-res}
...
\item from 19.6 m of raw drift down to \textbf{2.58--3.56 m} of start-pinned ATE,
  without degrading the heading (median 2.2--3.0°) — figures~\ref{fig:bruce-traj}
  and \ref{fig:bruce-err};
...
(no rotation, §~\ref{sec:protocole}b).}
...
\ref{fig:bruce-usbl-sections}, and a start-pinned ATE of \textbf{8.09--10.90 m} —
...
in the raw frame, §~\ref{sec:chap1-usbl}) — the positions are right relative to the
