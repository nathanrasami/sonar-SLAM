...
anything}: the orientation of the estimated frame is part of the system output — it
is initialised on board from the first USBL fixes (position of the first fix,
course-over-ground heading), the GT-free equivalent of the \texttt{/initialpose} a
deployed vehicle receives. The ATE is the RMSE of the point-to-point distances
