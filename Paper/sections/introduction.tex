...
sonar (FLS) is often the only dense sensor. Bruce-SLAM~\hyperref[bib:bruceslam]{[1]} demonstrates
...
\autoref{fig:pipeline} summarises the pipeline as actually executed. Chapter~1
...
(DISO~\hyperref[bib:diso]{[3]}, ISOPoT~\hyperref[bib:isopot]{[4]}) and the most realistic one operationally — every method starts
