...
Facteurs decides (mesures dans PROGRESS 2026-07-15) :
  L1 image sonar (AddSigma/MultSigma HoloOcean) ........ x5  (0.01 -> 0.05)
...
# L1 — image sonar (valeurs absolues, pas un multiplicateur : x5 de 0.01)
SONAR_ADD = 0.05 if ON else 0.01
SONAR_MULT = 0.05 if ON else 0.01
