...
export SLAM_RESULTS_DIR="$CHEMIN" && for i in analyze_drift.py analyze_origine.py plot_trajectories.py reverse_cap.py plot_heading_comparison.py filter_cloud.py; do python3 "$i" || break; done
