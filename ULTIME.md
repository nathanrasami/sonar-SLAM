...
|---|---|---|---|
| RU5 | `USBL_ADAPTIVE=true ./run_slam.sh` | U6 σ adaptatif par fix | garde si ATE<1.47 à carte égale (p90≤0.42) |
...
## U6 — σ USBL adaptatif par fix ✅ CODÉ + JUSTIFIÉ PAR LES DONNÉES → RU5
...
- 07-04 (nuit) : **U6 codé** (σ adaptatif par fix, proxy MAD validé offline corr. 0.64,
  loi clip(3.4·MAD, 0.9, 3.5)) → **RU5 = seul run restant proposé**. Verdict U7 :
